...
//
{
   ...
   {                                                   // derive these 10 coefficients satisfying 10 constraints
      coefficients[0][2][d] = 0;
      coefficients[0][1][d] = 0;
      coefficients[0][0][d] = 0;

      coefficients[1][3][d] = 0;
      coefficients[1][2][d] = 0;
      coefficients[1][1][d] = 0;
      coefficients[1][0][d] = 0;

      coefficients[2][2][d] = 0;
      coefficients[2][1][d] = 0;
      coefficients[2][0][d] = 0;
   }  // end for d = each dimension
